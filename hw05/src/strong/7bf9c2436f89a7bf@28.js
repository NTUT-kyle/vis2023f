...
function _randomMemberScore(group_11)
{
...
function _strong(d3,group_11,drag,url_list,invalidation)
{
  // 指定圖表的尺寸。
  const width = 2000;
  const height = 400;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("strong")).define("strong", ["d3","group_11","drag","url_list","invalidation"], _strong);
  return main;
}
